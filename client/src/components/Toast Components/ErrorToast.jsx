    ...
    <div>
      {showToast && (
        <div
          ...
          className="fixed flex items-center justify-between w-full max-w-xs p-4 space-x-2 text-gray-500 bg-white border-2 border-gray-300 rounded-lg shadow right-5 bottom-5 dark:text-gray-400 dark:border-gray-700 dark:bg-gray-800 mx-8"
          role="alert"
        >
